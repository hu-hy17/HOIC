...
if __name__ == "__main__":
    ...
    for seq_idx, mi in enumerate(tqdm.tqdm(meta_info['test'][:1])):
        ...
        img_path_list = [
            'F:/hhy/py/getRGB/data/{}/left_color_'.format(object_name),
            'J:/code/HandObjInteraction/UIC/results/img/{}_live2/Label/'.format(object_name) + str(seq_idx) + '/ref_',
            'J:/code/HandObjInteraction/UIC/results/img/{}_live2/SA22/'.format(object_name) + str(seq_idx) + '/ref_',
            'J:/code/HandObjInteraction/UIC/results/img/{}_live2/Label/'.format(object_name) + str(seq_idx) + '/mimic_',
        ]
        video_name = '{}_live_label_'.format(object_name) + str(seq_idx)
